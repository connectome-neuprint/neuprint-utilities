...
def fetch_top_level(payload, datestruct, datasetn, suffix):
    ...
    datestruct['TOTAL_pre_complete_percent'] = '%.3f' % (datestruct['TOTAL_pre_complete'] / datestruct['TOTAL_pre'] * 100.0)
    datestruct['TOTAL_post_complete_percent'] = '%.3f' % (datestruct['TOTAL_post_complete'] / datestruct['TOTAL_post'] * 100.0)
